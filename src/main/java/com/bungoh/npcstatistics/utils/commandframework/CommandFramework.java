...
public class CommandFramework implements CommandExecutor {
	...
	public static <T> void registerParser(Class<T> clazz, ArgumentParser<T> parser) {
		parsers.put(clazz, parser);
	}

	public static <T> ArgumentParser<T> getParserOf(Class<T> type) {
		try {
	...
	public CommandFramework(Plugin plugin) {
		...
		registerParser(OfflinePlayer.class, argument -> {
			try {
		...
		registerParser(Number.class, argument -> {
			try {
